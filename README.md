...
The unit suite currently contains 59 assertions across the financial calculations, date helpers, currency helpers, and platform contracts. Separating the workflow into four jobs makes it clear whether a failure belongs to ledger behavior, configuration, web packaging, or Android packaging.
