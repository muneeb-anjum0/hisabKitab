import { fundIconType } from '../../lib/fundIconType';
...
const paths = {
  ...
  fuel: (
    <>
      <path d="M6 21V5h9v16M4 21h13M8 8h5" />
      <path d="m15 8 3 3v6c0 2 3 2 3 0V9l-2-2" />
    </>
  ),
  study: (
    <>
  ...
  savings: (
    <>
      ...
      <path d="M8 9V6h8v3M9 14h6" />
    </>
  ),
  personal: (
    <>
      <circle cx="12" cy="8" r="4" />
      <path d="M5 21c.5-5 3-7 7-7s6.5 2 7 7" />
    </>
  ),
  misc: (
    <>
...
export default function FundIconBadge({ name }) {
  return (
    <span className="fund-icon-badge" aria-hidden="true">
      <svg
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
