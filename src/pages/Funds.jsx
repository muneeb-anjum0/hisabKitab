...
export default function Funds() {
  ...
  return <>
    <div className="page-title funds-title"><span className="kicker">EVERY RUPEE HAS A JOB</span><h1>THE FUNDS</h1><p>Separate pockets. One honest ledger.</p><Button onClick={() => setCreating(true)}>+ NEW FUND</Button></div>
